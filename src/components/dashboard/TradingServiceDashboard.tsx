...
export default function TradingServiceDashboard({ role }: { role: string }) {
  ...
  const [selectedPeriod,  setSelectedPeriod]     = useState<PeriodKey>("last_12_months")
  ...
  return (
    <div style={{ background: "var(--bg)", minHeight: "100%", fontFamily: "'Inter', sans-serif", color: "var(--text)", padding: "1rem 1.5rem" }}>
      <style>{`
        ...
        .tsd .hero-left p  { font-size: 0.82rem; color: var(--text-muted); margin: 0; display: flex; align-items: center; gap: 8px; }
      ...
      <div className="tsd">
        ...
        <div className="hero">
          ...
          <div className="hero-right">
            ...
            {/* Bell notifications — separated by a divider */}
        ...
        {/* ── KPI Cards (6 main + 2 overdue counts) ── */}
