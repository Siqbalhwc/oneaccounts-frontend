  ...
  return (
    <div style={{ padding: 24, background: "var(--bg)", minHeight: "100vh", fontFamily: "'Inter', sans-serif", color: "var(--text)" }}>
      <style>{`
        ...
        .header-row {
          display: grid;
          grid-template-columns: 120px 90px 0.8fr 100px 70px 120px 36px 78px;
          padding: 14px 24px;
        ...
        @media (max-width: 640px) {
          .header-row, .data-row { grid-template-columns: 80px 70px 0.8fr 70px 60px 80px 30px 70px; padding: 10px 12px; }
        }
      `}</style>
