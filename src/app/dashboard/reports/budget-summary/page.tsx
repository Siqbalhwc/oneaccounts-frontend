...
export default function BudgetSummaryPage() {
  ...
  const exportPDF = () => {
    ...
    autoTable(doc, {
      head: [["Project", "Donor", "Activity", "Location", "Account Code", "Account Name", "Budget"]],
      body: tableData,
      startY: 35,
    })
    ...
    <div style={{ padding: "20px 24px", fontFamily: "Segoe UI, system-ui, sans-serif", background: "#f0f4f8", minHeight: "100vh" }}>
      ...
      <div className="card" style={{ overflowX: "auto" }}>
        {loading ? (
          ...
          <p style={{ color: "#94a3b8", textAlign: "center", padding: 40 }}>No budget lines found. Create a budget on the Budget vs Actual page.</p>
        ) : (
            ...
            <tbody>
              {rows.map((row, idx) => (
                <tr key={idx}>
                  ...
                  <td style={{ textAlign: "right", fontWeight: 600 }}>{formatPKR(row.amount)}</td>
                </tr>
              ))}
              {/* Total row */}
