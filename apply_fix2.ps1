...
export default function InvestorCapitalPage() {
  ...
  useEffect(() => { fetchProjectInvestors(); fetchSiteBudget() }, [selectedProjectId, companyId])
...
Write-Host "SUCCESS: investor-capital/page.tsx replaced with Edit % feature added." -ForegroundColor Green