...
export async function generateCustomerLedgerPDF(data:CustomerLedgerPDFData):Promise<jsPDF>{
  ...
  autoTable(doc,{
    ...
    didParseCell:(hookData)=>{
      // Center the header text for Debit, Credit, Balance
      if (hookData.section === 'head' && hookData.column.index >= 3) {
        hookData.cell.styles.halign = 'center'
      }
      const rowData=hookData.row.raw as string[]
      if(rowData && rowData[2]==="Opening Balance"){hookData.cell.styles.fontStyle="bold";hookData.cell.styles.fillColor=[240,240,245]}
      if(rowData && rowData[2]==="Total"){hookData.cell.styles.fontStyle="bold";hookData.cell.styles.fillColor=NAVY;hookData.cell.styles.textColor=WHITE}
    }
  })
